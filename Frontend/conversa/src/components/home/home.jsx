    ...
    <div className="home">
      <div className="hero">
        <div className="hero-content">
          ...
          <Link to="/login"className="cta-button" >Empieza Ahora!</Link>
        </div>
      ...
      <div className="features">
        ...
        <div className="feature-cards">
          <div className="feature-card">
            ...
            <p>¡Conecta instantaneamente con tus amigos!.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">🔒</div>
            <h3>Chat Seguro</h3>
            <p>¡Tus conversaciones siempre seran seguras!.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">🌐</div>
            <h3>Chat Global</h3>
            <p>¡Comunicate desde cualquier rincón del mundo!.</p>
          </div>
        </div>
      </div>

      <div className="testimonials">
        <h2>¿Que opinan nuestros usuarios?</h2>
      ...
      <footer>
        ...
        <div className="footer-bottom">
          <p>&copy; 2025 Conversa. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
